    ...
    var convertDataRequestToHTTP = function (type, resource, params) {
        ...
        switch (type) {
            case ra_core_1.GET_LIST: {
                ...
                var query = __assign({}, ra_core_1.fetchUtils.flattenObject(params.filter), { _sort: field, _order: order, _start: (page - 1) * perPage, _end: page * perPage });
            ...
            case ra_core_1.GET_MANY_REFERENCE: {
                ...
                var query = __assign({}, ra_core_1.fetchUtils.flattenObject(params.filter), (_a = {}, _a[params.target] = params.id, _a._sort = field, _a._order = order, _a._start = (page - 1) * perPage, _a._end = page * perPage, _a));
                url = apiUrl + "/" + resource + "?" + query_string_1.stringify(query);
                break;
            }
